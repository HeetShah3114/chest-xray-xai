...
This implementation uses helper_functions.py for the convolution functions (conv1x1, conv3x3)
and aa_conv2d.py for the attention-augmented convolutional layers.
"""
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
        ...
        if attn_params is not None:
            ...
            # Scale input_dims to the feature map size at this layer.
